...
<section id="Speakers" class="index">
    <div class="container">
      <div class="row">
...
<script type="text/javascript">
  function searchname(){
    ...
    window.location.href = "<?php echo base_url(); ?>index.php/speaker/index/"+nama;
  }
</script>
